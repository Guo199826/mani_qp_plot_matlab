...
set(gca,'fontsize',14);
set(gcf,'position',[10,10,600,350])
xlim([0 num_rows*dt])
...
figure(2)
hold on;
set(gcf,'position',[10,400,600,350])
% guidance
...
set(gca,'fontsize',14);
set(gcf,'position',[10,730,600,350])
xlim([0 num_rows*dt])
% xlabel('$t$','fontsize',22,'Interpreter','latex');
% ylabel('$q$','fontsize',22,'Interpreter','latex');
...
set(gcf,'position',[630,10,600,350])
...
set(gcf,'position',[1300,10,600,350])
set(gca,'fontsize',14);
xlim([0 num_rows*dt])
...
for row_real = 1:200:num_rows_real
    ...
    set(gca,'FontSize',14);
    set(gcf,'position',[630,400,500,300])
    % axis square;
    % axis equal;
    ...
    set(gca,'FontSize',14);
    set(gcf,'position',[1100,400,500,300])
    % axis square;
    % axis equal;
    xlabel('$x$','fontsize',38,'Interpreter','latex');
    ...
    set(gca,'FontSize',14);
    set(gcf,'position',[630,750,500,300])
    % axis square;
    % axis equal;
...
% hold on;
% Jt_geom_init = geomJ(robot,position_real(1,:));
% J_xy = Jt_geom(4:5,:);
% J_xz(1,:) = Jt_geom(4,:);
% J_xz(2,:) = Jt_geom(6,:);
% J_yz = Jt_geom(5:6,:);
...
% figure('position',[10 10 450 450],'color',[1 1 1]);
% hold on;
% plotGMM([0;0], 1E-2*Me_d_xy, clrmap(3,:), .6, '-.', 3, 1);
% plotGMM([0;0], 1E-2*Me_ct_xy, clrmap(2,:), .3, '-', 3, 1);
% xlabel('$x_1$','fontsize',38,'Interpreter','latex'); ylabel('$x_2$','fontsize',38,'Interpreter','latex');
% xlim([-2 2]);ylim([-2 2]);
% % xlim([-1.2 1.2]);ylim([-1.2 1.2]);
...
set(gca,'fontsize',14);
set(gcf,'position',[1100,750,400,200])
xlim([0 num_rows*dt])
% xlabel('$t$','fontsize',22,'Interpreter','latex');
% ylabel('$q$','fontsize',22,'Interpreter','latex');
xlabel('Time t(s)','FontSize',22,'Interpreter','latex');
...
set(gca,'fontsize',14);
set(gcf,'position',[1500,700,500,500])
xlim([0 num_rows*dt])
% xlabel('$t$','fontsize',22,'Interpreter','latex');
% ylabel('$q$','fontsize',22,'Interpreter','latex');
